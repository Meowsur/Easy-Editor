...
import os # модуль для работы с o.c
...
btn_dir.setStyleSheet("background-color: grey;")
...
btn_smooth = QPushButton("Сглаживать")
btn_left.setStyleSheet("background-color: grey;")
btn_right.setStyleSheet("background-color: grey;")
btn_flip.setStyleSheet("background-color: grey;")
btn_bw.setStyleSheet("background-color: grey;")
btn_sharp.setStyleSheet("background-color: grey;")
btn_detail.setStyleSheet("background-color: grey;")
btn_blur.setStyleSheet("background-color: grey;")
btn_smooth.setStyleSheet("background-color: grey;")
...
col2 = QVBoxLayout()    
col1.addWidget(btn_dir)     # В ПЕРВОМ КНОПКА ДИРЕКТОРИИ
